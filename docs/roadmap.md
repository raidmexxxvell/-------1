...
- [ ] **API для игроков**: `POST/PUT/DELETE /api/admin/players`

**Следующий этап:**
- [ ] **API для игроков**: `POST/PUT/DELETE /api/admin/players`
- [ ] **Админ-интерфейс**: Форма добавления игроков с привязкой к командам
- [ ] **Заполнение**: ~200 игроков с позициями, номерами, датами рождения
- [ ] **Критерий успеха**: Все игроки в БД, поиск и фильтрация работают
